...
{
    con.query("SELECT profesor.*, clase.nom_cla, categoria.nom_cat FROM profesor INNER JOIN clase ON profesor.fky_cla=clase.cod_cla INNER JOIN categoria ON profesor.fky_cat=categoria.cod_cat", function (err, result, fields) 
    {
        if (err) console.log(err);
