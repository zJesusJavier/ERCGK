...
function formularioEditarUsuario(capb)
{
    ...
    con.query("SELECT * FROM usuario WHERE id_usu='" + captionid + "'" , function (err, result, fields) 
    {
        con.query("SELECT * FROM elementos WHERE fky_usuario='" + captionid + "'" , function (err, result1, fields) 
        {
